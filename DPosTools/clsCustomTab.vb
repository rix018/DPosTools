...
Class DotNetBarTabcontrol
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        ' BOTTOM BOX, UNOCCUPIED AREA
        G.FillRectangle(New SolidBrush(Color.FromArgb(52, 152, 219)), New Rectangle(0, 0, ItemSize.Height + 4, Height))
        ...
        For i = 0 To TabCount - 1
            If i = SelectedIndex Then
                ...
                G.FillRectangle(New SolidBrush(Color.FromArgb(41, 128, 185)), x2)

                ' SELECTED TAB BORDER HIGHLIGHT
                G.DrawRectangle(New Pen(Color.FromArgb(248, 248, 255)), x2)
                ...
                ' LITTLE TRIANGLE BORDER COLOR
                G.DrawPolygon(New Pen(Color.FromArgb(248, 248, 255)), p)
                ...
                If ImageList IsNot Nothing Then
                    ...
                    End Try
                Else
                    ' THE TEXT ON THE SELECTED TAB PAGE
            ...
            Else
                ...
                ' UNSELECTED TAB BACK COLOR
                G.FillRectangle(New SolidBrush(Color.FromArgb(52, 152, 219)), x2)

                ' BORDER FOR TAB NAME
                G.DrawRectangle(New Pen(Color.FromArgb(41, 128, 185)), x2)
